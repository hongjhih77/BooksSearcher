...
public class BooksDotComBookParserTest {
  ...
  public Object[][] createData1() {
    return new Object[][] {
            { "9789862419830", "Google模式：挑戰瘋狂變化世界的經營思維與工作邏輯", "How Google Works",
            "9789862419830", 352, "Eric Schmidt, Jonathan Rosenberg", "天下雜誌", "2014/11/07"},

            {"9789579609203", "第十年的情人節", "素敵な日本人",
            "9789579609203", 288, "東野圭吾", "春天出版社", "2018/02/28"},

            {"9789864002047", "在家自學的四個孩子", null,
            "9789864002047", 224, "許惠珺", "道聲", "2018/04/10"}
    };
  }

  @Test(dataProvider = "testBook")
  public void testGetBook(String key, String title, String originalTile,
                          String ISBN13, int pages, String authors, String publisher, String publishedDate ) throws ParseException {

    IBookParser iBookParser = new BooksDotComBookParser();
    Book bookParsed = iBookParser.getBook(key);
